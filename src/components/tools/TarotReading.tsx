...
const MAJOR_ARCANA: TarotCard[] = [
  {
    ...
    keywords: { ko: '새 출발·순수·모험', en: 'New beginnings · Innocence · Adventure', ja: '新たな始まり・純粋・冒険', fr: 'Nouveau départ · Innocence · Aventure', es: 'Nuevo comienzo · Inocencia · Aventura', zh: '新開始·純真·冒險' },
    upright: { ko: '새로운 시작, 자유로운 정신, 무한한 가능성이 열려있습니다. 두려움 없이 앞으로 나아가세요.', en: 'A new journey begins. Embrace freedom and infinite possibility — step forward without fear.', ja: '新しい旅の始まり。恐れなく前に進み、無限の可能性を受け入れましょう。', fr: 'Un nouveau voyage commence. Avancez sans crainte et embrassez les possibilités infinies.', es: 'Un nuevo viaje comienza. Avanza sin miedo y abraza las posibilidades infinitas.', zh: '新旅程開始，無所畏懼地前進，接受無限可能。' },
  ...
  },
  {
    ...
    keywords: { ko: '의지·창조·기술·행동', en: 'Will · Creation · Skill · Action', ja: '意志・創造・技術・行動', fr: 'Volonté · Création · Compétence · Action', es: 'Voluntad · Creación · Habilidad · Acción', zh: '意志·創造·技能·行動' },
    upright: { ko: '당신에게는 목표를 이룰 모든 자원이 있습니다. 집중하고 능력을 발휘하세요.', en: 'You have all the resources to achieve your goals. Focus your will and act with skill.', ja: '目標を達成するためのすべてのリソースがあります。意志を集中させ、能力を発揮しましょう。', fr: 'Vous avez toutes les ressources pour atteindre vos objectifs. Concentrez votre volonté et agissez.', es: 'Tienes todos los recursos para lograr tus metas. Concentra tu voluntad y actúa con habilidad.', zh: '您擁有實現目標的所有資源，集中意志並施展能力。' },
    reversed: { ko: '재능을 낭비하거나 조종당하고 있을 수 있습니다. 자신의 능력에 의구심이 생길 때입니다.', en: 'Talent may be wasted or manipulated. Question whether you are using your abilities well.', ja: '才能が無駄にされているか、操られているかもしれません。能力を活かせているか問い直しましょう。', fr: 'Votre talent peut être gaspillé ou manipulé. Remettez en question votre utilisation de vos capacités.', es: 'El talento puede ser desperdiciado o manipulado. Cuestiona si estás usando bien tus habilidades.', zh: '才能可能被浪費或受操縱，質疑自己是否善用能力。' },
  },
  {
    id: 2, symbol: '🌙',
    name: { ko: '여교황 (The High Priestess)', en: 'The High Priestess', ja: '女教皇', fr: 'La Papesse', es: 'La Sacerdotisa', zh: '女祭司' },
    keywords: { ko: '직관·신비·내면의 지혜', en: 'Intuition · Mystery · Inner wisdom', ja: '直感・神秘・内なる知恵', fr: 'Intuition · Mystère · Sagesse intérieure', es: 'Intuición · Misterio · Sabiduría interior', zh: '直覺·神秘·內在智慧' },
    upright: { ko: '내면의 목소리에 귀를 기울이세요. 직관이 최고의 안내자입니다.', en: 'Listen to your inner voice. Intuition is your greatest guide right now.', ja: '内なる声に耳を傾けましょう。直感が最高の案内者です。', fr: 'Écoutez votre voix intérieure. L\'intuition est votre meilleur guide.', es: 'Escucha tu voz interior. La intuición es tu mejor guía ahora mismo.', zh: '傾聽您的內心聲音，直覺現在是您最好的嚮導。' },
  ...
  },
  {
    ...
    keywords: { ko: '성찰·고독·내면 탐구·지혜', en: 'Reflection · Solitude · Inner search · Wisdom', ja: '内省・孤独・内面探求・知恵', fr: 'Réflexion · Solitude · Recherche intérieure · Sagesse', es: 'Reflexión · Soledad · Búsqueda interior · Sabiduría', zh: '反思·孤獨·內在探索·智慧' },
    upright: { ko: '홀로 내면을 탐구할 시간입니다. 고독 속에서 지혜를 찾으세요.', en: 'Time for inner exploration alone. Seek wisdom in solitude and quiet reflection.', ja: 'ひとりで内面を探求する時間です。孤独の中に知恵を見つけましょう。', fr: "Il est temps d'explorer votre intérieur seul(e). Cherchez la sagesse dans la solitude.", es: 'Es tiempo de exploración interior solo. Busca sabiduría en la soledad y la reflexión tranquila.', zh: '獨自探索內心的時刻，在孤獨中尋求智慧。' },
    reversed: { ko: '고립이 지나치거나 외로움을 느끼고 있습니다. 세상과 다시 연결될 시간입니다.', en: 'Too much isolation or loneliness. It is time to reconnect with the world.', ja: '孤立が過ぎるか、孤独を感じています。世界と再びつながる時間です。', fr: 'Trop d\'isolement ou solitude. Il est temps de se reconnecter avec le monde.', es: 'Demasiado aislamiento o soledad. Es tiempo de reconectarte con el mundo.', zh: '過於孤立或感到孤獨，是時候重新與世界連結了。' },
  },
  {
    id: 10, symbol: '☸️',
    name: { ko: '운명의 수레바퀴 (Wheel of Fortune)', en: 'Wheel of Fortune', ja: '運命の輪', fr: 'La Roue de Fortune', es: 'La Rueda de la Fortuna', zh: '命運之輪' },
    keywords: { ko: '변화·운명·순환·전환점', en: 'Change · Destiny · Cycles · Turning point', ja: '変化・運命・循環・転換点', fr: 'Changement · Destin · Cycles · Tournant', es: 'Cambio · Destino · Ciclos · Punto de inflexión', zh: '變化·命運·循環·轉折點' },
    upright: { ko: '운명이 당신 편입니다. 변화의 흐름을 받아들이고 기회를 잡으세요.', en: 'Fortune turns in your favor. Embrace the flow of change and seize the opportunity.', ja: '運命があなたの味方です。変化の流れを受け入れ、チャンスをつかみましょう。', fr: 'La fortune tourne en votre faveur. Embrassez le flux du changement et saisissez l\'opportunité.', es: 'La fortuna gira a tu favor. Abraza el flujo del cambio y aprovecha la oportunidad.', zh: '命運對您有利，接受變化的流動並抓住機會。' },
  ...
  },
  {
    ...
    keywords: { ko: '희망·영감·치유·축복', en: 'Hope · Inspiration · Healing · Blessings', ja: '希望・インスピレーション・癒し・祝福', fr: 'Espoir · Inspiration · Guérison · Bénédictions', es: 'Esperanza · Inspiración · Curación · Bendiciones', zh: '希望·靈感·療癒·祝福' },
    upright: { ko: '희망과 치유의 빛이 비추고 있습니다. 꿈을 믿고 앞으로 나아가세요.', en: 'The light of hope and healing shines on you. Believe in your dreams and move forward.', ja: '希望と癒しの光が照らしています。夢を信じて前に進みましょう。', fr: "La lumière de l'espoir et de la guérison brille sur vous. Croyez en vos rêves et avancez.", es: 'La luz de la esperanza y la curación brilla sobre ti. Cree en tus sueños y avanza.', zh: '希望與療癒的光芒照耀著您，相信您的夢想並前進。' },
    reversed: { ko: '희망을 잃거나 영감이 고갈되었습니다. 작은 긍정에 집중하고 서서히 회복하세요.', en: 'Loss of hope or dried inspiration. Focus on small positives and recover gradually.', ja: '希望を失うか、インスピレーションが枯れています。小さなポジティブに集中し、徐々に回復しましょう。', fr: "Perte d'espoir ou inspiration tarie. Concentrez-vous sur les petites choses positives.", es: 'Pérdida de esperanza o inspiración agotada. Enfócate en pequeñas cosas positivas y recupérate gradualmente.', zh: '失去希望或靈感枯竭，專注於小的積極事物並逐漸恢復。' },
  },
  {
    id: 18, symbol: '🌑',
    name: { ko: '달 (The Moon)', en: 'The Moon', ja: '月', fr: 'La Lune', es: 'La Luna', zh: '月亮' },
    keywords: { ko: '환상·두려움·잠재의식·불확실', en: 'Illusion · Fear · Subconscious · Uncertainty', ja: '幻想・恐れ・潜在意識・不確かさ', fr: 'Illusion · Peur · Subconscient · Incertitude', es: 'Ilusión · Miedo · Subconsciente · Incertidumbre', zh: '幻覺·恐懼·潛意識·不確定' },
    upright: { ko: '잠재의식의 두려움과 환상이 현실을 흐리고 있습니다. 직관을 믿되 실제를 직시하세요.', en: 'Subconscious fears and illusions cloud reality. Trust intuition but face what is real.', ja: '潜在意識の恐れと幻想が現実を曇らせています。直感を信じながら現実を見据えましょう。', fr: "Les peurs du subconscient et les illusions brouillent la réalité. Faites confiance à votre intuition mais regardez en face ce qui est réel.", es: 'Los miedos subconscientes y las ilusiones nublan la realidad. Confía en tu intuición pero enfrenta lo real.', zh: '潛意識的恐懼和幻覺模糊了現實，相信直覺但面對真實。' },
