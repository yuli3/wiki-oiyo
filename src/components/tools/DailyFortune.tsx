...
const FORTUNE_TEXTS = {
  overall: {
    ...
    cn: {
      good: [
        "今天帶來美好能量，事事順遂。主動出擊，好結果自然會來。",
        "正能量充滿全天。是開始你一直推遲之事的最佳時機。",
        "新機遇正在敲門。保持警覺，不要錯過周圍的信號。",
      ],
      mid: [
        "平靜穩定的一天等待著你。不要急躁，期待合理的結果。",
        "今天能量一般。選擇安全穩定的選項而不是冒險。",
        "安靜平淡的一天。專注於與周圍人的有意義的交流。",
      ],
      bad: [
        "今天耐心將是你最大的財富。保持穩定，避免過度伸展。",
        "可能會出現挑戰，但它們會過去。保持冷靜心態。",
        "專注於鞏固而非擴展。用今天來準備和加強你的基礎。",
      ],
    },
  },
  love: {
    ...
    cn: {
      good: [
        "與愛人創造特別時刻的最佳日子。坦率地表達你的感情。",
        "今天遇到新人的機會很高。用開放的心環顧四周。",
        "你的關係今天深化得很美好。分享真心的對話。",
      ],
      mid: [
        "戀愛生活穩定。簡單的日常愛意比大手筆今天更閃耀。",
        "與伴侶分享小小的日常時刻就帶來足夠的幸福。",
        "戀愛運一般。帶著感恩而非期待度過這一天。",
      ],
      bad: [
        "可能會出現誤解。仔細聽聽你的伴侶真正在說什麼。",
        "今天可能有情緒波動。避免衝動決定。",
        "今天愛情能量弱。花些獨處時間反思內心。",
      ],
    },
  ...
  health: {
    ...
    cn: {
      good: [
        "今天健康能量好。享受運動或戶外活動。",
        "今天身心都充滿活力。開始新的健康例行程序。",
        "今天充滿活力。是開始你一直推遲鍛煉的好時機。",
      ],
      mid: [
        "健康處於平均水平。保持你的常規健康習慣。",
        "沒有特別的擔憂，但今天需要充分休息。",
      ...
      bad: [
        "避免過度工作，充分休息。傾聽你身體的信號。",
        "你的消化或免疫系統可能需要關注。注意飲食。",
        "今天健康能量低。休息而不是強行進行劇烈活動。",
      ],
    },
  },
  career: {
    ...
    cn: {
      good: [
        "今天事業運閃耀。如果有重要的演示或會議，自信地面對它們。",
        "今天你可以給老闆或同事留下好印象。積極分享你的意見。",
        "承擔新項目或角色的理想日子。不要害怕迎接挑戰。",
      ],
      mid: [
        "事業運一般。盡職盡責將為你贏得認可。",
        "今天穩定的努力而非大變化更閃耀。",
        "今天團隊合作是關鍵。與同事合作實現共同目標。",
      ],
      bad: [
        "注意工作中的衝突或誤解。今天需要謹慎的言行。",
        "今天可能發生工作失誤。仔細檢查重要任務。",
        "今天事業運弱。專注於現有工作而不是新嘗試。",
      ],
    },
  },
};
