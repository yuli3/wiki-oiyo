...
const SEASONS: Record<Season, SeasonData> = {
  spring: {
    ...
    bestColors: [
      ...
      { name: { ko: "골든 옐로우", en: "Golden Yellow", ja: "ゴールデンイエロー", fr: "Jaune doré", es: "Amarillo dorado", zh: "金黃色" }, hex: "#FFD700" },
  ...
  summer: {
    ...
    avoidColors: [
      ...
      { name: { ko: "머스터드", en: "Mustard", ja: "マスタード", fr: "Moutarde", es: "Mostaza", zh: "芥末黃" }, hex: "#FFDB58" },
  ...
  autumn: {
    ...
    bestColors: [
      ...
      { name: { ko: "머스터드", en: "Mustard", ja: "マスタード", fr: "Moutarde", es: "Mostaza", zh: "芥末黃" }, hex: "#FFBA00" },
