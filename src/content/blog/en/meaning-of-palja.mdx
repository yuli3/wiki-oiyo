...
pubDate: '2026-01-18'
definition: "Saju is often called 'Four Pillars,' but its heart is the 'Eight Characters' (Palja)."
...
- **Calculate your Saju**: [oiyo.net/en/saju/calculator](https://oiyo.net/en/saju/calculator) — compute your Four Pillars (Heavenly Stems, Earthly Branches, Five Elements) from your birth date and time.
- **Western counterpart — Natal Chart**: [oiyo.net/en/natal/chart](https://oiyo.net/en/natal/chart) — read the same birthday through the Sun, Moon, and Rising signs.
